...
from karma_parser import parse_message, create_transactions
...
def process_karma(message, db_session, timeout):
    ...
    transactions = create_transactions(message.author.name.lower(), raw_karma)
    ...
    # reply = 'I have changed the karma of the following item{plural} as requested:\n' \
    #         '{karma_items}{error_str}'
    ...
    for transaction in transactions:
        ...
        if not karma_item:
            ...
            delta = datetime.now() - karma_item.altered
        ...
        karma_item.altered = datetime.now()
